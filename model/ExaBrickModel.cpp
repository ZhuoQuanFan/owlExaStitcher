...
namespace exa {
  ...
  ExaBrickModel::SP ExaBrickModel::load(const ExaBrick *bricksIN,
                                        ...
                                        size_t numBricks)
  {
    ...
    memcpy(bricks.data(),bricksIN,sizeof(bricksIN[0])*numBricks);
    ...
    scalars.resize(numCells);
    memcpy(scalars.data(),scalarsIN,numCells*sizeof(scalarsIN[0]));
